...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bKali.setOnClickListener { appenOnClick(true,"*") }
        bKurang.setOnClickListener { appenOnClick(true,"-") }
        bBagi.setOnClickListener { appenOnClick(true,"/") }
        bPersen.setOnClickListener { appenOnClick(true,"%") }
        bTambah.setOnClickListener { appenOnClick(true,"+") }
